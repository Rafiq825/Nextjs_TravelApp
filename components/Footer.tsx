  ...
  return (
    <footer className="flexCenter mb-24">
      <div className="padding-container max-container flex w-full flex-col gap-14">
        ...
        <p className="regular-14 w-full text-center text-gray-50">2023 Hilink | All rights reserved</p>
      </div>
...
type FooterColomunsProps={
  title:string;
  children:React.ReactNode
}

const FooterColumns=({title, children}:FooterColomunsProps)=>{
  return (
    <div className="flex flex-col gap-5">
